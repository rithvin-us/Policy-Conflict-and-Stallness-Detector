...
ACTION_SYNONYMS: dict[str, str] = {
    "rotate": "rotate", "rotation": "rotate", "refresh": "rotate",
    "cycle": "rotate", "change": "rotate", "changes": "rotate",
    "encrypt": "encrypt", "encrypted": "encrypt", "encryption": "encrypt",
    "retain": "retain", "retained": "retain", "retention": "retain",
    "keep": "retain", "store": "retain", "stored": "retain",
    "delete": "delete", "deleted": "delete", "deletion": "delete",
    "erase": "delete", "purge": "delete", "remove": "delete",
    "enforce": "enforce", "enforced": "enforce", "require": "enforce",
    "use": "use", "used": "use", "using": "use", "enable": "use",
    "review": "review", "reviewed": "review",
    "reuse": "reuse", "reused": "reuse",
    "bypass": "bypass", "exempt": "bypass", "skip": "bypass",
    "log": "log", "logged": "log", "logging": "log", "monitor": "log",
    "backup": "backup", "back": "backup",
    "apply": "apply", "applied": "apply",
    "classify": "classify", "label": "classify",
}
