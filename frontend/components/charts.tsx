  ...
  return (
    <ResponsiveContainer width="100%" height={180}>
      <BarChart data={data} margin={{ top: 8, right: 8, bottom: 0, left: -18 }}>
        ...
        <YAxis allowDecimals={false} tick={{ fill: "#000000", fontSize: 11 }} axisLine={false} tickLine={false} />
  ...
  return (
    <ResponsiveContainer width="100%" height={300}>
      <LineChart data={chartData} margin={{ top: 20, right: 30, left: -20, bottom: 0 }}>
        ...
        <XAxis dataKey="date" tick={{ fill: "#000000", fontSize: 11 }} axisLine={false} tickLine={false} minTickGap={30} />
        <YAxis tick={{ fill: "#000000", fontSize: 11 }} axisLine={false} tickLine={false} />
