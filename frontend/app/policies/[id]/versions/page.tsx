...
export default function PolicyVersionsPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-xl font-semibold text-black">Version History</h1>
        <p className="mt-1 text-sm text-black">Compare policy changes over time.</p>
      </div>

      <div className="grid grid-cols-12 gap-6">
        <Panel className="col-span-12 lg:col-span-6" title="Old Version">
          <select 
            className="w-full bg-ink-900 border border-white/10 rounded px-2 py-1 text-sm text-black mb-4"
            value={selectedV2 || ""}
